...
public sealed class SuppliersController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<PagedResult<SupplierDto>>> Get([FromQuery] ListQuery request, CancellationToken cancellationToken)
    ...
    [HttpPost]
    public async Task<ActionResult<Guid>> Create([FromBody] SaveSupplierRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, [FromBody] SaveSupplierRequest request, CancellationToken cancellationToken)
    {
